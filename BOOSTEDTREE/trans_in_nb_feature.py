...
def main(postrain_f , negtrain_f , postest_f , negtest_f , gram_n , otrain_f , otest_f ) :
    ...
    logging.info("compute r .")
    r = compute_logcount_ratio(pos_train_words_counter , neg_train_words_counter , docs_dict)
    ...
    X = build_SVM_format_X_from_docs_words(train_docs , docs_dict , r)
    ...
    X = build_SVM_format_X_from_docs_words(test_docs  , docs_dict , r)
